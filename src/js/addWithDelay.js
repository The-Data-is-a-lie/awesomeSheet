...
// Module Pattern (alternative to exports)
var module = (function () {
  ...
  // Return the public functions
  return {
    addSpellWithDelay: addSpellWithDelay,
    addFeatWithDelay: addFeatWithDelay,
    addTraitWithDelay: addTraitWithDelay,
    addLanguageWithDelay: addLanguageWithDelay,
    addAbilitiesWithDelay: addAbilitiesWithDelay
  };

})();

// Usage example (assuming these functions are in a separate file)
module.addSpellWithDelay(1, "Fireball")
  .then(() => console.log("Spell added!"))
  .catch(error => console.error("Error adding spell:", error));

module.addFeatWithDelay("Great Weapon Master")
  .then(() => console.log("Feat added!"))
  .catch(error => console.error("Error adding feat:", error));

// Similar usage for addTraitWithDelay, addLanguageWithDelay, and addAbilitiesWithDelay
